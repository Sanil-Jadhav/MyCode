...
<body id="page-top">
			...
			<li class="nav-item active">
				...
				<div id="collapse_nav_transporter_f2h" class="collapse show" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
					<div class="bg-white py-2 collapse-inner rounded">
						...
						<a class="collapse-item active" href="user/search/transporter_f2h">Search & view</a>						
					</div>
				</div>
			</li>
								...
								<div class="card-body">
									<form>
										...
										<div class="form-group mb-5">
											<label for="transporter_f2h_id_input" class="text-blue " >Student ID (Autogenerated)</label> 
						...
						<div class="col">
							...
							<div class="card shadow mb-4">
								<div class="card-body">
									...
									<button class="btn btn-success btn-icon-split float-right update_btn" type="button">
	...
	<script src="content/js/view_student.js"></script>

	<script type="text/javascript">


     var student_id = getUrlParameter("i").toLowerCase();
